...
def main():
    ...
    outcomes = {}
    for model_name in ("./output2/model-best", "fr_core_news_md"): #, "fr_core_news_lg"):
        print(model_name)
    ...
    bootstrap.test(targets, outcomes['./output2/model-best'], outcomes['fr_core_news_md'], "H0", "H1",sample_size=.5, n_loops=500, verbose=True)
