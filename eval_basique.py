        ...
        for line in f:
            ...
            if not line.startswith("#"):
                ...
                if line == "":# si la ligne est vide = fin de phrase
                    ...
                    tokens = []# forme, tag et oov, de nouveau vide pour la nouvelle phrase
                else:
                    fields = line.split("\t")
...
#creation de Doc pour avoir les .token
...
# inverse on prend un doc pour en faire une phrase, prise en cpt de tokenisation
